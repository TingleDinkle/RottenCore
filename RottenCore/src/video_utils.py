...
class VideoFramesDataset(Dataset):
    ...
    """
    def __init__(self, video_path, target_width, target_height, device=None):
        # device is accepted for compatibility but not strictly used for caching in this version 
        # to save memory compared to the previous 'av' version which loaded everything to GPU RAM.
